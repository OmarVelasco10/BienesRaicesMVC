<fieldset>
                ...
                <?php if($propiedad->imagenes) { ?>
                    <img src="/imagenes/<?php echo $propiedad->imagenes?>" class="imagen-small"> 
                <?php } ?>

                <label for="descripcion">Descripcion</label>
                <textarea  id="descripcion" name="propiedad[descripcion]" cols="30" rows="10" ><?php echo sanitizar($propiedad->descripcion); ?></textarea>
            </fieldset>
